...
def pedirNumeroEntero():
    ...
    while not correcto:
        try:
            num = int(input("Escribe un numero de las siguientes opciones: "))
            correcto = True
        except ValueError:
            print("Error, Por favor escribe el numero de las opciones que aparecen")
...
while not salir:
    print ("------------------AUTOMATAS, ACTIVIDAD 2 UNIDAD 5----------------------")
    print("")
